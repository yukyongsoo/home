				...
				items : [
					{
						...
						desc : "운영 어플리케이션의 성능을 모니터링하며 장애 감지 및 파악에 쓰이는 도구. 1인 개발",
						stack : "AspectJ, H2, Netty, Vaadin, jsoniter, vaadin-addon", 
						func : ["1. Service 모니터링","2. App 자원 사용량(Cpu,Heap)","3. 서버 자원 사용량(Disk,Network,Cpu)",
							"4. App Log Trace","5. App Metric Trace","(Method, Db Query)","6. Data Statistics",
							"7. Exception Catch","8. Runtime Decomplie","9. Thread State Snapshot","10. Java Memory Pool State"
						],
						mod : ["1. Agent : 각 APP에 삽입되어 데이터를 수집하여 Raw Data로 가공 후 Collector로 전송",
						...
						demo : "dev",
						images : ["apmarch.JPG","apmmod.JPG","apmscr1.png","apmscr2.png","apmscr3.png","apmscr4.png"]
					},
					{
						icon : "flash_on",
						name : "CSP(ECM)",
						text : "비정형 문서 관리 시스템",
						desc : "전통적인 ECM 사상을 이용하여 현대에 맞도록 개량중인 CSP 솔루션. 1인 개발",
						stack : "Spring Boot, Vue, Vue-Material,Gson, Spring-security"
							+ ",http-components, jasypt, quartz",
						func : ["1. Document Service","2. Version Service","3. Search Service",
							"4. Folder Service","5. Life Cycle Service","6. Manage Service",
							"7. Meta Data Service","8. User/Group SPI","9. ACL/Secure SPI"
						],
						mod : ["1. API : Server가 가진 모든 기능을 관리자 웹만이 아닌 API를 통해 조정할 수 있도록 구현." +
					...
					},
					{
						...
						name : "Team KMS",
						text : "사내 지식 전파 시스템",
						desc : "사이트,솔루션 히스토리 관리 및 장애 전파/대응 지원을 위한 시스템 . 6인 팀 개발",
						stack : "Spring Boot, Vue, Vuetify, Hibernate, JPA, My-Sql, Elastic Search",
						func : ["1.Site Service","2.Solution Service","3.QnA Service","4.Alram Service(본인 파트)"
								,"5. Manage Service" ,"6. SPI", "7. Search Service"
							],
